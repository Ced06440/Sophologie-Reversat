...
<header id="homepage">
                <nav class="navbar navbar-expand-lg text-uppercase fixed-top mt-2" id="mainNav">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ms-auto nav-bar text-center" style="list-style-type:none;">
                            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link rounded" href="#homepage">Accueil</a></li>
                            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link rounded" href="#sophro">Sophrologie</a></li>
    ...
    <footer>
        <div class="row text-center mt-4">
            <p>Site réalisé par <a href="http://www.ageek.fr/" target="_blank">Ageek.fr</a></p>
        </div>
